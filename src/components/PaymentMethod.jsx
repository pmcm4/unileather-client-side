...
const MethodsContainer = styled.div`
  ...
  border: 2px solid 
    ${(props) =>
      // @ts-ignore
      props.isSelected ? "#59302D" : "rgba(231, 238, 244, 1)"};
...
const PaymentMethod = ({ onChoosePm }) => {
  ...
  return (
    <Container>
      ...
      <SubTitle>{t("CHOOSE YOUR PAYMENT METHOD")}</SubTitle>
      <MethodsContainer
        // @ts-ignore
      ...
      >
        ...
        <MethodsTitle>{t("CREDIT/DEBIT CARD")}</MethodsTitle>
      ...
      >
      <Image
          src="https://res.cloudinary.com/dgb2lnz2i/image/upload/v1652496107/paypal_PNG20_unlsnr.png"
          alt={t("checkout.paymentMethod.paypalAlt")}
        />
        <MethodsTitle >{t("PAYPAL")}</MethodsTitle>
        <StyledArrowRightAltOutlined />
      </MethodsContainer>
    </Container>
  )
